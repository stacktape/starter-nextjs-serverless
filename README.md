...
# Next.js Serverless (OpenNext)

> [!TIP]
> To deploy this project using **GUI-based flow**, navigate to [console](https://console.stacktape.com/create-new-project/git-project-using-console?name=my-stacktape-app&repositoryType=public&repositoryUrl=https://github.com/stacktape/starter-nextjs-serverless)

- [Next.js](https://nextjs.org/) app deployed serverlessly via the
  [nextjs-web resource](https://docs.stacktape.com/compute-resources/nextjs-web/) — Lambda + S3 + CloudFront CDN.
- Zero-config deployment. Includes a server-rendered page and an API route example.
- Optionally add a database — see commented section in `stacktape.yml`.
...
```bash
stacktape init --starterId nextjs-serverless
```
